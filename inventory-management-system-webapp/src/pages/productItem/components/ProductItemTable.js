...
export default function ProductItemTable(props) {
    ...
    <Box>
      {openDialog && (
        <DeleteEntryDialog
          ...
          entryId={objectId}
          text={"Czy napewno chcesz usunąć produkt " + objectName + " ?"}
        />
      )}
                ...
                .map((row, index) => {
                  return (
                    <TableRow key={`${row}${index}`}>
                      ...
                      <TableCell align="left">
                        <Typography>{row.productItemName}</Typography>
                      </TableCell>
                      ...
                      <TableCell>
                        ...
                        >
                          <Button
                            ...
                            onClick={() =>
                              openInDialog(row.id, row.productItemName)
                            }
                          >
                            Usuń
                          </Button>
                          <Button
                            component={Link}
                            to={{
                              pathname: "editProductItem/" + row.id,
                            }}
                            state={{
                              editedProductItem: row,
                            }}
                            size="small"
                            variant="contained"
                            color="info"
