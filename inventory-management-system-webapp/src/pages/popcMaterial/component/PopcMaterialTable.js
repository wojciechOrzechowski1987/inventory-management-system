...
export default function PopcMaterialTable(props) {
    ...
    <Box>
      {openDialog && (
        <DeleteEntryDialog
          ...
          entryId={objectId}
          text={"Czy napewno chcesz usunąć materiał " + objectName + " ?"}
        />
      )}
      <Paper sx={{ width: "100%", minHeight: "53vh", mb: 2 }}>
                  ...
                  return (
                    <TableRow key={`${row}${index}`}>
                      <TableCell align="left" width={"150"}>
                        <Typography>{row.popcMaterialCode}</Typography>
                      </TableCell>
                      <TableCell align="left" width={"400"}>
                        <Typography>{row.popcMaterialName}</Typography>
                      </TableCell>
                      ...
                      <TableCell align="left" width={"150"}>
                        ...
                        >
                          <Button
                            ...
                            onClick={() =>
                              openInDialog(row.id, row.popcMaterialName)
                            }
                          >
                            Usuń
                          </Button>
                          <Button
                            component={Link}
                            to={{
                              pathname: "editMaterial/" + row.id,
                            }}
                            state={{
                              editedPopcMaterial: row,
                            }}
                            size="small"
                            variant="contained"
                            color="info"
        ...
        <TablePagination
          ...
          labelRowsPerPage="Materiałów na stronę:"
          labelDisplayedRows={({ from, to, count }) =>
            `Wyświetlono ${from}-${to} materiałów z ${count}`
          }
        />
      </Paper>
    </Box>
